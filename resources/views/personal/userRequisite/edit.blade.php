    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route('personal.user.requisite.update', $userrequisite->id )}}" method="post">
                            @csrf
                            @method('patch')
                            <div class="form-group w-25">
                                <input type="text" name="title_bank" class="form-control" placeholder="title_bank"
                                       value="{{$userrequisite->title_bank}}"
                                >
                                @error('title_bank')
